...
const CodingHeading = () => {
  ...
  return (
    ...
    <div className="flex items-center w-full justify-center bg-[url('../../public/coding/c/deepLearning_background.png')]  bg-cover bg-center	bg-no-repeat h-[50vh] lg:h-[90vh]">
    ...
    <div className="flex items-center  justify-center gap-10 flex-col md:flex-row w-5/6 ">
      <Image src={cIcon} alt="C Programming" width={100} className="w-20 md:w-32" />
      <p className="text-sm md:text-xl basis-9/12	md:text-left md:rtl:text-right">{t("ciconText")}</p>
    </div>
    ...
    <div className="flex items-center justify-center  container flex-col md:flex-row  md:w-2/3 gap-10 md:gap-0 ">
      <p className="mx-8 text-sm md:text-xl md:text-left basis-1/2 md:rtl:text-right">{t("chelpText")}</p>
    ...
    <div className=" flex items-center justify-center relative w-full h-full ">
      <div className="absolute  w-full  mt-12">
        <Image className="m-auto hidden md:block h-auto" src={pythonBackground} alt="python image" width={500} height={500} />
      </div>
    </div>

    <div className="flex container  flex-col-reverse md:flex-row items-center justify-center  relative  gap-10 md:gap-36 pb-20 ">
      <Image src={cCode} alt="python image" className="w-80 md:w-96  object-cover z-10" />
      ...
      <Image src={pythonSide} alt="python image" className="scale-50 h-400px w-auto absolute top-36 right-0 invisible md:visible" />
    </div>
  </div>
  );
};

export default CodingHeading;
