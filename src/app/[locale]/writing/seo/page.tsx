  ...
  return (
    <div className="flex items-center justify-center flex-col gap-[50px] bg-background_color text-center md:text-left font-poppins overflow-hidden">
      <div className="bg-[url('../../public/writing/seo/bckgrnd1.png')] w-full flex items-center bg-cover bg-center	bg-no-repeat justify-center relative">
        <div className="flex items-center  justify-center container flex-col md:flex-row py-10">
      ...
      <div className=" text-[16px] md:text-[20px] rtl:text-right container text-center flex items-center justify-center w-5/6 md:w-2/3 relative">
        {t("seopara2")}
      ...
      <div className="bg-[url('../../public/writing/seo/bckgrnd.png')]  bg-contain bg-center  bg-no-repeat w-full  flex items-center justify-center">
        <div className=" w-5/6  flex items-center justify-center	 relative py-20 container">
          ...
          <div className="flex items-center justify-center flex-col  container  md:w-5/6 gap-10 md:gap-20">
            <Image
              src={image2}
              alt="art image"
              width={100}
